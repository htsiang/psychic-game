...
document.onkeyup = function() {
    ...
    // Computer pseudo randomly chooses letter from letterArray to place in computerLetter
    //but only when numberOfGuess===9
    if (numberOfGuesses===9) {
        computerLetter = letterArray[Math.floor(Math.random()*letterArray.length)];
    };
